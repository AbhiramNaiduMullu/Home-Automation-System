...
%.o: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"D:/ti/ccs1220/ccs/tools/compiler/ti-cgt-armllvm_2.1.2.LTS/bin/tiarmclang.exe" -c -mcpu=cortex-m4 -mfloat-abi=soft -mfpu=none -mlittle-endian -mthumb -Oz -I"D:/344/workspace_v12/adcsinglechannel_CC3235SF_LAUNCHXL_tirtos_ticlang" -I"D:/344/workspace_v12/adcsinglechannel_CC3235SF_LAUNCHXL_tirtos_ticlang/MCU+Image" -I"D:/ti/simplelink_cc32xx_sdk_6_10_00_05/source" -I"D:/ti/simplelink_cc32xx_sdk_6_10_00_05/source/ti/posix/ticlang" -DDeviceFamily_CC3220 -gdwarf-3 -march=armv7e-m -MMD -MP -MF"$(basename $(<F)).d_raw" -MT"$(@)" -I"D:/344/workspace_v12/adcsinglechannel_CC3235SF_LAUNCHXL_tirtos_ticlang/MCU+Image/syscfg"  $(GEN_OPTS__FLAG) -o"$@" "$<"
...
syscfg/%.o: ./syscfg/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: Arm Compiler'
	"D:/ti/ccs1220/ccs/tools/compiler/ti-cgt-armllvm_2.1.2.LTS/bin/tiarmclang.exe" -c -mcpu=cortex-m4 -mfloat-abi=soft -mfpu=none -mlittle-endian -mthumb -Oz -I"D:/344/workspace_v12/adcsinglechannel_CC3235SF_LAUNCHXL_tirtos_ticlang" -I"D:/344/workspace_v12/adcsinglechannel_CC3235SF_LAUNCHXL_tirtos_ticlang/MCU+Image" -I"D:/ti/simplelink_cc32xx_sdk_6_10_00_05/source" -I"D:/ti/simplelink_cc32xx_sdk_6_10_00_05/source/ti/posix/ticlang" -DDeviceFamily_CC3220 -gdwarf-3 -march=armv7e-m -MMD -MP -MF"syscfg/$(basename $(<F)).d_raw" -MT"$(@)" -I"D:/344/workspace_v12/adcsinglechannel_CC3235SF_LAUNCHXL_tirtos_ticlang/MCU+Image/syscfg"  $(GEN_OPTS__FLAG) -o"$@" "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
